...
if __name__ == '__main__':
  ...
  parser = argparse.ArgumentParser(description="Transform Occluded Duke Dataset")
  parser.add_argument('--zip_file', type=str,
                      default='/content/drive/MyDrive/PersonReID-YouReID/dataset/Occluded_Duke/Occluded_Duke_yeni.zip')
  parser.add_argument('--save_dir', type=str,
                      default='/content/drive/MyDrive/PersonReID-YouReID/dataset/Occluded_Duke/data')
